...
<html lang="en">
  <head>
    ...
    <title>To-Do | Create To-Do Page</title>
...
.bg-purple-light {
      ...
      <h3 class="text-white text-center"><a href="{{ route('applicant.dashboard') }}" class="text-white text-decoration-none">Dashboard</a></h3>
        <ul class="nav flex-column">
          <li class="nav-item mb-3">
            <a href="{{ route('applicant.todos.create') }}" class="nav-link mt-2 active">Create New To-Do</a>
          </li>
          <li class="nav-item mb-3">
  ...
  <div class="col-md-8">
        <h1 class="mt-4">Create New To-Do</h1>

        <form action="{{ route('applicant.todos.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-success" style="display: inline-block; line-height: 22px;text-align:center; font-weight: bold" >Save</button>
