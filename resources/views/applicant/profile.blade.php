...
<head>
  ...
  <title>To-Do | User Profile Page</title>
    ...
    <div class="row">
      ...
      <div class="col-md-2 bg-purple-light p-4 sidebar">
        <h3 class="text-white text-center">
          <a href="{{ route('applicant.dashboard') }}" class="text-white text-decoration-none">Dashboard</a>
        </h3>
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-3">
            <a href="{{ route('applicant.profile') }}" class="nav-link active">View Profile</a>
          </li>
          <li class="nav-item mb-3">
        ...
        <div class="col-md-6 bg-light p-5 rounded shadow">
          ...
          <form action="{{ route('applicant.profile.update') }}" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name" name="name" value="{{ old('name', auth()->guard('applicant')->user()->name) }}">
              @error('name')
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" name="email" value="{{ old('email', auth()->guard('applicant')->user()->email) }}">
              @error('email')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" name="username" value="{{ old('username', auth()->guard('applicant')->user()->username) }}">
              @error('username')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
