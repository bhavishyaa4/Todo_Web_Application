...
<html lang="en">
  <head>
    ...
    <title>To-Do Admin | User Page</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          @if(session('success'))
              <div class="alert alert-success mt-3 "style="width:40%">{{ session('success') }}</div>
            @endif
          <div class="row mt-4">
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{ route('admin.user.todos', $user->id) }}" class="btn btn-primary">View To-Dos</a>
                    <form action="{{ route('admin.user.destroy', $user->id) }}" method="post" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete the user and their To-Do list?')">Delete</button>
                    </form>
                  </div>
                </div>
              </div>
